...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const errMsg = extractErrorMessage(error, "Registration Failed. Please try a different email.");
            toast.error("✗ " + errMsg);
        }
    };
            ...
            >
                <div className="text-center flex flex-col items-center">
                    ...
                    <p className="text-xs text-slate-400 mt-1.5 max-w-xs leading-relaxed">
                        Join our bespoke collection registry and start securing certified designs.
                    </p>
                </div>

                <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-2">
                    <div className="flex flex-col gap-1.5 text-left">
                        <label htmlFor="register-name" className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
                            Full Name
                        </label>
                    ...
                    <div className="flex flex-col gap-1.5 text-left">
                        <label htmlFor="register-email" className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
                            Email Address
                        </label>
                        <div className="relative flex items-center">
                    ...
                    <div className="flex flex-col gap-1.5 text-left">
                        <label htmlFor="register-password" className="text-[10px] font-bold uppercase tracking-wider text-slate-400">
                            Password
                        </label>
                        <div className="relative flex items-center">
